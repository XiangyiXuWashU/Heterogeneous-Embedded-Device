...
package/cfg/dsp_pe674.se674: package/cfg/dsp_pe674.c package/cfg/dsp_pe674.mak
	...
	$(RM) $@
	@$(MSG) cle674 -n $< ...
	$(ti.targets.elf.C674.rootDir)/bin/cl6x -c -n -s --symdebug:none -g --optimize_with_debug -qq -pdsw225 -mv6740 --abi=eabi -eo.oe674 -ea.se674  -D_DEBUG_=1  -Dxdc_cfg__header__='configPkg/package/cfg/dsp_pe674.h'  -Dxdc_target_name__=C674 -Dxdc_target_types__=ti/targets/elf/std.h -Dxdc_bld__profile_debug -Dxdc_bld__vers_1_0_7_4_4 --symdebug:dwarf  $(XDCINCS) -I$(ti.targets.elf.C674.rootDir)/include -fs=./package/cfg -fr=./package/cfg -fc $<
