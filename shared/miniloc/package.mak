...
package/%.xdc.inc package/%_miniloc.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package miniloc" (because $@ is older than $(firstword $?))" ...
...
package/rel/undefinedminilocpackage/package.rel.xml: package/package.cfg.xdc.inc
package/package.cfg.xdc.inc: $(XDCROOT)/packages/xdc/cfg/cfginc.js package.xdc
	@$(MSG) generating schema include file list ...
	$(CONFIG) -f $(XDCROOT)/packages/xdc/cfg/cfginc.js miniloc $@
...
.PHONY: release,miniloc
miniloc.zip: package/package.bld.xml
miniloc.zip: package/build.cfg
miniloc.zip: package/package.xdc.inc
miniloc.zip: package/package.cfg.xdc.inc
ifeq (,$(MK_NOGENDEPS))
-include package/rel/miniloc.zip.dep
endif
package/rel/miniloc/miniloc/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

miniloc.zip: package/rel/miniloc.xdc.inc package/rel/miniloc/miniloc/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELZIP,package/rel/miniloc.xdc.inc,package/rel/miniloc.zip.dep)


release release,miniloc: all miniloc.zip
clean:: .clean
	-$(RM) miniloc.zip
	-$(RM) package/rel/miniloc.xdc.inc
	-$(RM) package/rel/miniloc.zip.dep
